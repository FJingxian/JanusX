...
use assoc::{
    ai_reml_multi_f64, ai_reml_null_f64, bed_packed_decode_rows_f32, bed_packed_decode_stats_f64, bed_packed_fit_stats_f64, bed_packed_row_flip_mask,
...
fn janusx(_py: Python, m: &Bound<PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(bed_packed_fit_stats_f64, m)?)?;
